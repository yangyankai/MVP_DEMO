...
import com.example.mvp_demo.model.entity.WeatherInfo;
import com.example.mvp_demo.present.WeatherPresenter;
import com.example.mvp_demo.present.impl.WeatherPresentImpl;
import com.example.mvp_demo.ui.common.BaseActivity;
...
public class WeatherActivity extends BaseActivity implements WeatherView, View.OnClickListener {
    ...
    private void init() {
        ...
        weatherPresenter = new WeatherPresentImpl(this); //传入WeatherView
